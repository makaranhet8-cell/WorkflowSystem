...
<head>
    ...
    <title>Submit Mission Request - Workflow System</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1>Submit Mission Request</h1>
        <form action="{{ route('mission-requests.store') }}" method="POST">
            @csrf
            @if(Auth::user()->hasAnyRole(['admin', 'system_admin', 'hr_manager', 'department_admin']))
                <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="purpose" class="form-label">Purpose / Objective</label>
                <textarea class="form-control" id="purpose" name="purpose" rows="3" placeholder="Describe the mission goal..." required>{{ old('purpose') }}</textarea>
