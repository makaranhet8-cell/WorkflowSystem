    ...
    @if (Auth::user()->can('create leaverequests'))
        ...
        <div class="container mt-5">
            ...
            <form action="{{ route('leave-requests.store') }}" method="POST">
                ...
                @else
                    <div class="mb-3">
                        <label class="form-label text-secondary">Requester</label>
                ...
                <div class="mb-4">
                    <label for="reason" class="form-label text-secondary">Reason</label>
                    <textarea class="form-control" id="reason" name="reason" rows="3" placeholder="Explain your leave reason..." required>{{ old('reason') }}</textarea>
